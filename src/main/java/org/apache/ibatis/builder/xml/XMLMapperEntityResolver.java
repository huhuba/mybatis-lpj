 ...
 *
 * <ul>目的是未联网的情况下也能做DTD验证，实现原理就是将DTD搞到本地，然后用org.xml.sax.EntityResolver，最后调用DocumentBuilder.setEntityResolver来达到脱机验证</ul>
 * EntityResolver
...
public class XMLMapperEntityResolver implements EntityResolver {
   ...
   * <ul>核心就是覆盖这个方法，达到转public DTD到本地DTD的目的</ul>
   *
   * @param publicId
