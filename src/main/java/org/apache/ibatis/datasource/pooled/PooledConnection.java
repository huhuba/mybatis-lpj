...
class PooledConnection implements InvocationHandler {
  ...
  // 记录当前PooledConnection对象所在的PooledDataSource对象，该PooledConnection是从该PooledDataSource中获取的，当调用close方法时会讲PooledConnection放回
  ...
  // 检测当前PooledConnection是否有效，主要是为了防止程序通过close方法将连接归还给连接池之后，依然通过该连接操作数据库
